...
static int futrts_main(struct futhark_context *ctx,
                       int32_t *out_scalar_out_4072, int32_t n_4050);
                       ...
                       int32_t *out_scalar_out_4072, int32_t n_4050)
{
    ...
    int err = 0;
    int32_t scalar_out_4070;
    int64_t n_4051 = sext_i32_i64(n_4050);
    bool bounds_invalid_upwards_4052 = slt32(n_4050, 1);
    int32_t distance_upwards_exclusive_4053 = sub32(n_4050, 1);
    int64_t distance_exclusive_4054 =
            sext_i32_i64(distance_upwards_exclusive_4053);
    int64_t distance_4055 = add64((int64_t) 1, distance_exclusive_4054);
    bool valid_4056 = !bounds_invalid_upwards_4052;
    bool range_valid_c_4057;
    
    if (!valid_4056) {
        ctx->error = msgprintf("Error: %s%lld%s%lld%s\n\nBacktrace:\n%s",
                               "Range ", (int64_t) 1, "...", n_4051,
                               " is invalid.",
                               "-> #0  example.fut:1:40-44\n   #1  example.fut:3:26-31\n   #2  example.fut:3:1-31\n");
        return 1;
    }
    
    int32_t defunc_2_reduce_res_4059;
    int32_t redout_4065 = 1;
    
    for (int64_t i_4066 = 0; i_4066 < distance_4055; i_4066++) {
        int32_t binop_x_4067 = sext_i64_i32(i_4066);
        int32_t index_primexp_4069 = add32(1, binop_x_4067);
        int32_t defunc_1_op_res_4062 = mul32(redout_4065, index_primexp_4069);
        int32_t redout_tmp_4071 = defunc_1_op_res_4062;
        
        redout_4065 = redout_tmp_4071;
    }
    defunc_2_reduce_res_4059 = redout_4065;
    
    int32_t entry_result_4064 = defunc_2_reduce_res_4059;
    
    scalar_out_4070 = entry_result_4064;
    *out_scalar_out_4072 = scalar_out_4070;
                       ...
                       int32_t in0)
{
    ...
    if (!true) {
        ...
        ret = futrts_main(ctx, &scalar_out_4070, n_4050);
        if (ret == 0) {
            *out0 = scalar_out_4070;
        }
    }
    lock_unlock(&ctx->lock);
    return ret;
